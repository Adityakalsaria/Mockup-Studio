...
export const SHOTS: Shot[] = [
  ...
  part("part-duo-open", "apple-iphone-duo-web", "duo-night-sky", { yAxis: 180, fold: 0 }, "dark-9.png", "top"),
  part("part-duo-closed", "apple-iphone-duo-web", "cloud-white", { yAxis: 20, xAxis: -4, fold: 100 }, "dark.png", "top"),
  ...
  /* Highlights. */
  ...(["studio", "dramatic", "top", "high-key", "rim"] as const).map((lighting): Shot => ({ id: `hl-light-${lighting}`, width: 400, height: 900, deviceId: "apple-iphone-17-pro", finishId: "silver", pose: { yAxis: 34, xAxis: 4, zoom: 0.78 }, lighting, background: solid("#000000"), screen: "dark.png" })),
  { id: "hl-dof", width: 1600, height: 900, deviceId: "apple-iphone-17-pro", finishId: "cosmic-orange", pose: { yAxis: 150, xAxis: 16, zAxis: -8, zoom: 1.05 }, lighting: "studio", background: gradient("#f7d9c4", "#c96f4a", 160), screen: "dark-4.png", blur: radial(40, 0.3) },
  ...
  { id: "ship-1x1", width: 640, height: 640, deviceId: "apple-iphone-18-pro", finishId: "iphone18-burgundy", pose: { yAxis: 204, xAxis: -8, zAxis: 10, zoom: 0.62 }, lighting: "studio", background: solid("#f7d9c4"), screen: "dark-2.png" },
  { id: "ship-9x16", width: 540, height: 960, deviceId: "apple-iphone-air", finishId: "space-black", pose: { yAxis: 160, zoom: 0.7 }, lighting: "top", background: solid("#121214"), screen: "dark-6.png" },

  /* Showcase -- varied on purpose: scale, angle, ground, crop. */
  { id: "sc-orange-back", width: 720, height: 900, deviceId: "apple-iphone-17-pro", finishId: "cosmic-orange", pose: { yAxis: -20, xAxis: 10, zAxis: 8, zoom: 0.9 }, lighting: "top", background: solid("#000000"), screen: "dark.png" },
  { id: "sc-air-gold", width: 720, height: 720, deviceId: "apple-iphone-air", finishId: "light-gold", pose: { yAxis: 150, xAxis: 18, zAxis: -24, zoom: 0.72 }, lighting: "studio", background: solid("#e8a87c"), screen: "dark-4.png" },
  { id: "sc-18-detail", width: 1280, height: 720, deviceId: "apple-iphone-18-pro", finishId: "iphone18-silver", pose: { yAxis: -32, xAxis: 20, zoom: 1.7, panY: 0.9, panX: 0.4 }, lighting: "top", background: solid("#121214"), screen: "dark-5.png" },
  { id: "sc-17-sage", width: 720, height: 900, deviceId: "apple-iphone-17", finishId: "sage", pose: { zoom: 0.74 }, lighting: "high-key", background: solid("#cfe3d4"), screen: "confirm-payment-1.png" },
  { id: "sc-imac-pink", width: 1280, height: 800, deviceId: "apple-imac-24", finishId: "imac-pink", pose: { yAxis: -24, xAxis: 4, zoom: 1.05 }, lighting: "high-key", background: solid("#f7d9c4"), screen: BOARD },
  { id: "sc-deep-blue", width: 720, height: 900, deviceId: "apple-iphone-17-pro-max", finishId: "deep-blue", pose: { yAxis: 146, xAxis: -10, zAxis: 12, zoom: 0.8 }, lighting: "studio", background: gradient("#4f5bd5", "#2a2f6b", 160), screen: "dark-7.png" },
  { id: "sc-neo-indigo", width: 1280, height: 800, deviceId: "apple-macbook-neo", finishId: "macbook-indigo", pose: { yAxis: -28, xAxis: 14, zoom: 1.1 }, lighting: "dramatic", background: solid("#252529"), screen: BOARD },
  ...
  { id: "grid-neo-citrus", width: 960, height: 600, deviceId: "apple-macbook-neo", finishId: "macbook-citrus", pose: { yAxis: -24, xAxis: 16, zoom: 1.15 }, lighting: "high-key", background: solid("#7fb08a"), screen: BOARD },
  { id: "grid-mbp-dark", width: 640, height: 640, deviceId: "apple-macbook-pro-14", finishId: "silver", pose: { yAxis: 30, xAxis: 20, zoom: 1.2 }, lighting: "top", background: solid("#121214"), screen: BOARD },
  { id: "grid-neo-blush", width: 640, height: 640, deviceId: "apple-macbook-neo", finishId: "macbook-blush", pose: { yAxis: -40, xAxis: 28, zoom: 1.1 }, lighting: "studio", background: solid("#f7d9c4"), screen: BOARD },
  { id: "grid-ipad-blue", width: 960, height: 600, deviceId: "apple-ipad-pro", finishId: "silver", pose: { yAxis: 200, xAxis: 10, zAxis: -8, zoom: 1.2 }, lighting: "high-key", background: solid("#8fa3e8"), screen: BOARD_TURNED },
  { id: "grid-imac-yellow", width: 640, height: 640, deviceId: "apple-imac-24", finishId: "imac-yellow", pose: { yAxis: 16, xAxis: 4, zoom: 1.1 }, lighting: "studio", background: solid("#e8a87c"), screen: BOARD },
  { id: "grid-imac-green", width: 640, height: 640, deviceId: "apple-imac-24", finishId: "imac-green", pose: { yAxis: -20, xAxis: 4, zoom: 1.1 }, lighting: "high-key", background: solid("#cfe3d4"), screen: BOARD },
  ...
  { id: "mu-iphone-dark", width: 640, height: 640, deviceId: "apple-iphone-air", finishId: "space-black", pose: { yAxis: 158, xAxis: 8, zAxis: -14, zoom: 1.35, panY: 0.5 }, lighting: "top", background: solid("#121214"), screen: "graphic-phone-lime" },
  ...
  { id: "mu-mac-dark", width: 640, height: 640, deviceId: "apple-macbook-pro-14", finishId: "space-black", pose: { yAxis: 8, xAxis: -6, zoom: 1.35, panY: 0.6 }, lighting: "top", background: solid("#121214"), screen: "graphic-mac-lime" },
  ...
  { id: "mu-reel-2", width: 720, height: 900, deviceId: "apple-macbook-pro-14", finishId: "silver", pose: { yAxis: 20, xAxis: 24, zoom: 1.5 }, lighting: "top", background: solid("#252529"), screen: "graphic-mac-lime" },
  ...
  { id: "mu-reel-4", width: 720, height: 900, deviceId: "apple-imac-24", finishId: "imac-green", pose: { yAxis: 18, zoom: 1.3 }, lighting: "high-key", background: solid("#f7d9c4"), screen: "graphic-mac-blue" },
  { id: "mu-reel-5", width: 720, height: 900, deviceId: "apple-iphone-18-pro", finishId: "iphone18-silver", pose: { yAxis: 140, xAxis: 6, zoom: 1.6, panY: 0.6 }, lighting: "top", background: solid("#121214"), screen: "graphic-phone-lime" },
  ...
  { id: "tile-dof", width: 640, height: 640, deviceId: "apple-iphone-18-pro", finishId: "iphone18-sky-blue", pose: { yAxis: 136, xAxis: 20, zoom: 1.35 }, lighting: "studio", background: solid("#cdd8f5"), screen: "dark-6.png", blur: radial(60, 0.25) },
  { id: "tile-lens", width: 640, height: 640, deviceId: "apple-iphone-17-pro", finishId: "deep-blue", pose: { yAxis: 130, xAxis: 24, zoom: 2.4, fov: 80 }, lighting: "dramatic", background: solid("#252529"), screen: "dark-7.png" },

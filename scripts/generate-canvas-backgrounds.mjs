...
const PRESETS = [
  ...
  },
  {
    ...
    grain: 0.016,
    fields: [
      [0.25, 0.25, 0.4, 0.3, "#e4eaff"],
      [0.8, 0.75, 0.4, 0.35, "#ffe7f0"],
    ],
  },
  {
    id: "sky",
    ...
    grain: 0.018,
    fields: [
      [0.2, 0.2, 0.4, 0.3, "#bddfff"],
      [0.85, 0.3, 0.35, 0.3, "#eef7ff"],
      [0.5, 0.92, 0.5, 0.3, "#a6c5ff"],
    ],
  },
  {
    id: "blush",
    ...
    grain: 0.02,
    fields: [
      [0.2, 0.3, 0.38, 0.3, "#ffcdd4"],
      [0.8, 0.2, 0.34, 0.3, "#fff0dd"],
      [0.62, 0.86, 0.42, 0.3, "#f5cdff"],
    ],
  },
  {
    id: "berry",
    ...
    grain: 0.026,
    fields: [
      [0.18, 0.2, 0.36, 0.3, "#ff4f9a"],
      [0.84, 0.24, 0.34, 0.3, "#7b2cff"],
      [0.2, 0.86, 0.36, 0.3, "#ff8a3d"],
      [0.82, 0.84, 0.36, 0.3, "#3a0f6b"],
    ],
  },
  {
    id: "sunset",
